...
int bcm2835_init(uint32_t peri_base)
{
    int  memfd;
    int  ok;
    FILE *fp;
    ...
    */
    fp = fopen(BCM2835_RPI2_DT_FILENAME , "rb");
    if (fp)
    {
        unsigned char buf[4];
	...
	/* this assignment is in case device-tree fails to open; at least provide base address from bulldog */
        bcm2835_peripherals_size = peri_base;
    }
